...
def annotate(family_file, variant_file, family_type, vep, silent, phased, strict, whole_gene, 
                annotation_dir, cadd_file, cadd_1000g, thousand_g, outfile, chr_prefix, verbose):
