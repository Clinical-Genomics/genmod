...
def test_genmod_annotate_features():
    ...
    runner = CliRunner()
    result = runner.invoke(cli, ["annotate", VCF_FILE, "-r"])
...
def test_genmod_annotate_features_empty_vcf():
    """docstring for test_genmod_annotate_models"""
    runner = CliRunner()
    result = runner.invoke(cli, ["annotate", EMPTY_VCF_FILE, "-r"])
...
def test_genmod_annotate_features_38():
    ...
    runner = CliRunner()
    result = runner.invoke(cli, ["annotate", VCF_FILE, "-r", "-b", "38"])
...
def test_genmod_annotate_thousand_g():
    """docstring for test_genmod_annotate_models"""
    runner = CliRunner()
    result = runner.invoke(cli, ["annotate", VCF_FILE, "--thousand-g", THOUSAND_G_FILE])
...
def test_genmod_annotate_multiple_cadd():
    ...
    result = runner.invoke(
        cli, ["annotate", VCF_FILE, "--cadd-file", CADD_FILE, "--cadd-file", CADD_1000G_FILE]
    )
