...
def test_x_affected_recessive_male():
    ...
    assert check_X_recessive(variant=recessive_variant, family=family) == True
...
def test_x_affected_male_ref_call():
    ...
    assert check_X_recessive(variant=homozygote_variant, family=family) == False
...
def test_x_affected_no_call_male_strict():
    ...
    assert check_X_recessive(variant=no_call_variant, family=family, strict=True) == False
