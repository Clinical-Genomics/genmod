...
def test_config_parser():
    ...
    assert set(config_reader.plugins) == set(['1000G', 'CADD', 'GeneticModels'])
    assert set(config_reader.categories.keys()) == set(['allele_frequency', 'deleteriousness', 'inheritance'])
